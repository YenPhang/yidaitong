...
<!--[if IE 6]>
<script src="${pageContext.request.contextPath }/statics/modifypsw/findPassWord/js/dd_belatedpng.js"></script>
...
function startAnimation(){
	$(".global-header .banner-loop").delay(3000).animate({opacity:0},500,"linear",function(){
		$(".global-header .banner-loop").css("background-image","url(statics/modifypsw/findPassWord/images/banner_03.png)");
		$(".global-header .banner-loop").animate({opacity:1},500,"linear",function(){
			$(".global-header .banner-loop").delay(2000).animate({opacity:0},500,"linear",function(){
				$(".global-header .banner-loop").css("background-image","url(statics/modifypsw/findPassWord/images/banner_02.png)");
        ...
        <h2 class="hd">
            <span class="t">找回密码</span>
             <div class="ab_r graya">
           	 <span class="blue">填写账户信息<i>></i></span><span>验证身份 <i>></i></span><span>设置新密码 <i>></i></span><span>完成</span>
            </div>
        </h2>
        <div class="bd">
        	<div class="margin">
        		<form method="post" action="${pageContext.request.contextPath }/fpsw">
            	<ul class="formli ul_v">
                	<li>
                    <em>账户信息</em>
                    	<label class="inp">
                    		<input type="text" name="userInp" class="i_text notEmpty" placeholder="输入用户名/认证邮箱/认证手机" />
                    	</label>
                    </li>
                    <li>
                    <em>验证码</em>
                    	<label class="inp" id="inp">
                   			<input type="text" name="imgCodeInp" class="i_text notEmpty" id="i_text" placeholder="输入验证码" />
                   		</label>
                    ...
                    <li class="tool">
                        <input type="submit" value="下一步" class="f_submit btn" />
                    </li>
                </ul>
                </form>
			</div>
			<!-- <div class="orange tip">如果忘记用户名/认证邮箱/认证手机,请联系客服&nbsp; 400-033-5158</div> -->
        	<div class="orange tip">如果忘记用户名/认证邮箱/认证手机,请&nbsp;<a href="/complain/index?optType=1" style="text-decoration: underline; cursor: pointer;">点击这里</a>&nbsp;找回</div>
        </div>
    </div>
</div>
	<nav id="redpack">
