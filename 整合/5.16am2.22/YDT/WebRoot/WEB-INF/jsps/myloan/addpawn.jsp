...
<!--[if IE 6]>
<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/dd_belatedpng.js"></script>
<script type="text/javascript">
DD_belatedPNG.fix('.png,.png:hover,img,background');
</script>
<![endif]-->
<link href="${pageContext.request.contextPath }/statics/myloan/addpawn/css/com.css" rel="stylesheet">
<link href="${pageContext.request.contextPath }/statics/myloan/addpawn/css/tf.css" rel="stylesheet">
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/myloan/addpawn/css/normalize.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/myloan/addpawn/css/iconfont.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/myloan/addpawn/css/base.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/myloan/addpawn/css/common.css">
<script>
Stringserver={
...
<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/jquery-1.7.2.min.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/digital.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/base.js"></script>

<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/eframe.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/fancyselect.js" charset="utf-8"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/md5.js"></script>
...
//		Stringserver.server=Stringserver.server || "";
    	...
    	var myAccountHtml="";
			...
			"<a href='https://app.etongdai.com/account/index'>Etdtljb120</a>" + 
...
</script><link href="${pageContext.request.contextPath }/statics/myloan/addpawn/css/my_com.css" rel="stylesheet">
<link href="${pageContext.request.contextPath }/statics/myloan/addpawn/css/diya.css" rel="stylesheet">
</head>
<body>
	<div id="toolbar">
	    ...
	    <div class="mobile-box">
	        <h3>扫描关注官方微信号</h3>
	        <img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/wechat.png" alt="易通贷">
	    </div>
	...
	<header class="grid global-header">
		<div class="grid-unit-1-3 logo" >
			<img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/banner_01.png" style="position: relative;top: 1px;" onclick="location.href='https://www.etongdai.com/'" alt="易通贷" title="易通贷" />
...
<div class="con_l">
	<div class="name">
            ...
            <li class="li3  "><a class="t"><span></span>我是投资者</a>
             ...
             <i class="cura"></i>
                <div class="zmenu">
                    ...
                    <a href="https://app.etongdai.com/collateral/query"class="cur2"><i>▪</i>我的抵押物<em></em></a>
                </div>
 	 ...
 	 <div class="service">
				...
				<div class="friend">
					<span class="t">我的抵押物</span>
				</div>
				<div class="adddiyaw form_all">
					<div class="form02">
					    <form action="https://app.etongdai.com/collateral/preview" method="post" enctype="multipart/form-data">  
						<ul class="formli ul_v">
							<li>
								<em>抵押物名称</em>
								<label class="inp">
									<input type="text" name="titleName" placeholder="请输入抵押物名称，20字以内" maxlength="20" class="i_text notEmpty"/>
								</label>
							</li>
							<li class="dyw_tex"><em>抵押物信息</em>
								<div class="inp">
									<textarea name="itdContent" maxlength="2000" placeholder="请输入抵押物信息描述，2000字以内" class="i_text notEmpty"></textarea>
								</div>
							</li>
							<li class="orange">选择您要上传的图片，支持上传JPG,GIF,PNG,BMP格式，每张大小在1MB以内</li>
							<li class="upfile"><em>图片1</em>
								<div class="uploader white">
									<label class="inp files">
										<input type="text" class="filename" readonly />
									</label> 
									<input type="button" name="file" class="btn2" value="浏览" /> 
									<input type="file" name="myfile" size="30" class="fileupload" />
								</div>
							</li>
							<li class="upfile"><em>图片2</em>
								<div class="uploader white">
									<label class="inp files">
										<input type="text" class="filename" readonly />
									</label> 
									<input type="button" name="file" value="浏览" class="btn2" /> 
									<input type="file" name="myfile" size="30" class="fileupload" />
								</div>
							</li>
							<li class="upfile"><em>图片3</em>
								<div class="uploader white">
									<label class="inp files">
										<input type="text" class="filename" readonly />
									</label> 
							...
							<li class="upfile"><em>图片5</em>
								<div class="uploader white">
									<label class="inp files">
										<input type="text" class="filename" readonly />
									</label> 
									<input type="button" value="浏览" name="file" class="btn2" /> 
									<input type="file" name="myfile" size="30" class="fileupload" />
								</div>
							</li>
							<li class="tool clearfix">
								<input type="submit" value="保存并预览" class="f_submit btn"/>
							</li>
						</ul>
						</form>
					</div>
	...
	<nav id="redpack">
		            <a href="https://app.etongdai.com/static/novice-guide/pc.html" target="_blank"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/redpacket.gif" style="margin-left:-17px;"/></a>
	</nav>
	<nav id="fixbar">
	    ...
	    <img class="downloadimg" src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/qrode_01.jpg" alt="APP下载">
	    <img class="wxdownloadimg" src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/qrode_02.png" alt="微信服务">
     </nav>
	...
	<footer class="grid global-footer">
	    <div>
	        ...
	        <div class="grid-unit-1-8 qrcode"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/qrode_01.jpg" alt="易通贷APP下载">易通贷APP下载</div>
	        <div class="grid-unit-1-8 qrcode"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/qrode_02.jpg" alt="关注微信-易通贷资讯">关注微信-易通贷资讯</div>
	...
	<section class="copyright">
	    <div class="authentic">  
	        <a href="http://webscan.360.cn/index/checkwebsite?url=www.etongdai.com" target="_blank"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/01.gif"></a>
	        <a href="https://search.szfw.org/cert/l/CX20140515008078008136" target="_blank"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/02.gif"></a>
	        <a href="http://www.isc.org.cn/xhhy/hydw/content-32.html" target="_blank"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/03.gif"></a>
	        <a href="https://ss.knet.cn/verifyseal.dll?sn=e14051911010849050et7r000000&amp;ct=df&amp;a=1&amp;pa=0.7002172293035737" target="_blank"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/04.gif"></a>
	        <a href="http://www.bcpcn.com/product/rz/bq/BCP2615734826.html" target="_blank"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/05.gif"></a>
	        <a href="http://www.315online.com.cn/member/315140031.html" target="_blank"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/06.gif"></a>
	        <a href="http://www.itrust.org.cn/home/index/itrust_certifi/wm/1571278794" target="_blank"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/wxrz-white.jpg"></a>
	        <a target="_blank" href="http://www.etongdai.com/p2p/help/guide/4/2017071111727.html"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/08.gif"></a>
	        <a href="http://www.cecy.org.cn/bencandy_search.php?fid=122&amp;id=1204" target="_blank"><img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/09.png"></a>
	        <a id="ppb" key ="587c78dbefbfb04f3bf057c6" logo_size="124x47" logo_type="business" href="http://www.anquan.org">
				<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/aq_auth.js"></script>
			</a>
	    </div>
	    ...
	    <p>
            ...
            <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010802024662"
               style="display:inline-block;text-decoration:none; vertical-align: top;">
                <img src="${pageContext.request.contextPath }/statics/myloan/addpawn/picture/ghs.png" style="float:left;"/>
...
<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/jquery.cookie.js" type="text/javascript" charset="utf-8"></script>
<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/html5.js" type="text/javascript" charset="utf-8"></script>
<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/common.js"></script>
<script>
	var _this = $("#ppb");
    _this.children("img").css({"width":"auto","height":"36"});
</script>	<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/czqcheck.js"></script>
	<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/eframe.js"></script>
	<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/log_reg.js"></script>
	<script src="${pageContext.request.contextPath }/statics/myloan/addpawn/js/my.js"></script>
<script>
    // 默认选中导航
...
$(function() {
	...
	$("input[type=file]").change(function() {
		$(this).parents(".uploader").find(".btn2").val("重新上传");
	});
	
	$(".i_text").checkInput({
		itdName:'titleName',
		itdContent:'itdContent'
	});
});
//下拉
...
<div style="display:none;">
	<script src='${pageContext.request.contextPath }/statics/myloan/addpawn/js/tongji_360.js' language='JavaScript' charset='gb2312'></script>
</div>
