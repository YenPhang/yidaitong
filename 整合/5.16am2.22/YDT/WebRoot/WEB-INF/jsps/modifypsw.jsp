        ...
        <h2 class="hd">
            <span class="t">找回密码</span>
             <div class="ab_r graya">
           	 <span>填写账户信息<i>></i></span><span>验证身份 <i>></i></span><span class="blue">设置新密码 <i>></i></span><span>完成</span>
            </div>
        </h2>
        <div class="bd">
        	<div class="margin">
        		<form method="post" action="https://app.etongdai.com/retrievepassword/modify">
            	<ul class="formli ul_v">
                	<li>
                    <em>新密码</em>
                    <label class="inp"><input type="password" id="userDraftLoginPswd" name="password" class="i_text notEmpty" placeholder="输入新密码" maxlength=16 /></label>
                   </li>
                   <li>
                    <em>确认密码</em>
                    <label class="inp"><input type="password" name="password2" class="i_text notEmpty" placeholder="再次输入新密码" maxlength=16/></label>
                   </li>
                   <li class="tool">
			...
			.keyup(
					function() {
						...
						if (false == enoughRegex.test($(this).val())) {
							$('.pass2').addClass('ruo');
							$('.pass2').removeClass('zhong');
							$('.pass2').removeClass('qiang');
						} else if (mediumRegex.test($(this).val())) {
							$('.pass2').removeClass('zhong');
							$('.pass2').addClass('qiang');
						} else {
							$('.pass2').removeClass('ruo');
							$('.pass2').addClass('zhong');
							$('.pass2').removeClass('qiang');
						}
						return true;
					});
