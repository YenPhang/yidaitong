...
<![endif]-->
<link href="${pageContext.request.contextPath }/statics/error/css/com.css" rel="stylesheet">
<link href="${pageContext.request.contextPath }/statics/error/css/css/tf.css" rel="stylesheet">
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/error/css/normalize.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/error/css/iconfont.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/error/css/base.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/error/css/common.css">
<script>
Stringserver={
...
<script src="${pageContext.request.contextPath }/statics/error/js/jquery-1.7.2.min.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/error/js/digital.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/error/js/base.js"></script>

<script src="${pageContext.request.contextPath }/statics/error/js/eframe.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/error/js/fancyselect.js" charset="utf-8"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/error/js/md5.js"></script>
...
<script type='text/javascript'>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/error/css/ts.css">
</head>
<body>
	<div id="toolbar">
	    ...
	    <div class="mobile-box">
	        <h3>扫描关注官方微信号</h3>
	        <img src="${pageContext.request.contextPath }/statics/error/picture/wechat.png" alt="易通贷">
	    </div>
	...
	<header class="grid global-header">
		<div class="grid-unit-1-3 logo" >
			<img src="${pageContext.request.contextPath }/statics/error/picture/banner_01.png" style="position: relative;top: 1px;" onclick="location.href='https://www.etongdai.com/'" alt="易通贷" title="易通贷" />
    ...
    <div class="wrongs con24 tishi">
        <div class="result clearfix">
            <em class="resultl"></em>
            <div class="resultr">
                <h3 id="wugao">${error}</h3>
                <p class="graya">如果您在浏览时多次出现此错误，请联系客服</p>
                <div class="tool clearfix">
                    <a href="javascript:history.go(-1);" class="look btn">返回上一页</a>
                    <a href="https://www.etongdai.com/" class="look1 btn2">返回首页</a>
                </div>
            </div>
        </div>
    </div>
	...
	<nav id="redpack">
		            <a href="https://app.etongdai.com/static/novice-guide/pc.html" target="_blank"><img src="${pageContext.request.contextPath }/statics/error/picture/redpacket.gif" style="margin-left:-17px;"/></a>
	</nav>
	<nav id="fixbar">
	    ...
	    <img class="downloadimg" src="${pageContext.request.contextPath }/statics/error/picture/qrode_01.jpg" alt="APP下载">
	    <img class="wxdownloadimg" src="${pageContext.request.contextPath }/statics/error/picture/qrode_02.png" alt="微信服务">
     </nav>
	...
	<footer class="grid global-footer">
	    <div>
	        ...
	        <div class="grid-unit-1-8 qrcode"><img src="${pageContext.request.contextPath }/statics/error/picture/qrode_01.jpg" alt="易通贷APP下载">易通贷APP下载</div>
	        <div class="grid-unit-1-8 qrcode"><img src="${pageContext.request.contextPath }/statics/error/picture/qrode_02.jpg" alt="关注微信-易通贷资讯">关注微信-易通贷资讯</div>
	...
	<section class="copyright">
	    <div class="authentic">  
	        <a href="http://webscan.360.cn/index/checkwebsite?url=www.etongdai.com" target="_blank"><img src="${pageContext.request.contextPath }/statics/error/picture/01.gif"></a>
	        <a href="https://search.szfw.org/cert/l/CX20140515008078008136" target="_blank"><img src="${pageContext.request.contextPath }/statics/error/picture/02.gif"></a>
	        <a href="http://www.isc.org.cn/xhhy/hydw/content-32.html" target="_blank"><img src="${pageContext.request.contextPath }/statics/error/picture/03.gif"></a>
	        <a href="https://ss.knet.cn/verifyseal.dll?sn=e14051911010849050et7r000000&amp;ct=df&amp;a=1&amp;pa=0.7002172293035737" target="_blank"><img src="${pageContext.request.contextPath }/statics/error/picture/04.gif"></a>
	        <a href="http://www.bcpcn.com/product/rz/bq/BCP2615734826.html" target="_blank"><img src="${pageContext.request.contextPath }/statics/error/picture/05.gif"></a>
	        <a href="http://www.315online.com.cn/member/315140031.html" target="_blank"><img src="${pageContext.request.contextPath }/statics/error/picture/06.gif"></a>
	        <a href="http://www.itrust.org.cn/home/index/itrust_certifi/wm/1571278794" target="_blank"><img src="${pageContext.request.contextPath }/statics/error/picture/wxrz-white.jpg"></a>
	        <a target="_blank" href="http://www.etongdai.com/p2p/help/guide/4/2017071111727.html"><img src="${pageContext.request.contextPath }/statics/error/picture/08.gif"></a>
	        <a href="http://www.cecy.org.cn/bencandy_search.php?fid=122&amp;id=1204" target="_blank"><img src="${pageContext.request.contextPath }/statics/error/picture/09.png"></a>
	        <a id="ppb" key ="587c78dbefbfb04f3bf057c6" logo_size="124x47" logo_type="business" href="http://www.anquan.org">
				<script src="${pageContext.request.contextPath }/statics/error/js/aq_auth.js"></script>
			</a>
	    </div>
	    ...
	    <p>
            ...
            <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010802024662"
               style="display:inline-block;text-decoration:none; vertical-align: top;">
                <img src="${pageContext.request.contextPath }/statics/error/picture/ghs.png" style="float:left;"/>
...
<script src="${pageContext.request.contextPath }/statics/error/js/jquery.cookie.js" type="text/javascript" charset="utf-8"></script>
<script src="${pageContext.request.contextPath }/statics/error/js/html5.js" type="text/javascript" charset="utf-8"></script>
<script src="${pageContext.request.contextPath }/statics/error/js/common.js"></script>
<script>
	var _this = $("#ppb");
...
<div style="display:none;">
	<script src='${pageContext.request.contextPath }/statics/error/js/tongji_360.js' language='JavaScript' charset='gb2312'></script>
</div>
