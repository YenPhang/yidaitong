...
{  
	...
	public String toString() {
		return "ItemCommon [itemCommonId=" + itemCommonId + ", iteLimitYuan="
				+ iteLimitYuan + ", iteReason=" + iteReason + ", applyDate="
				+ applyDate + ", endDate=" + endDate + ", iteBidMin=" + iteBidMin
				+ ", iteBidDate=" + iteBidDate + ", iteYearRate=" + iteYearRate
				+ ", iteRepayInterval=" + iteRepayInterval + ", iteRepayDate="
				+ iteRepayDate + ", iteBidSum=" + iteBidSum + ", iteRepayType="
				+ iteRepayType + ", iteTitle=" + iteTitle + ", itdContent="
				+ itdContent + ", loanerId=" + loanerId + ", repayTotalMoney="
				+ repayTotalMoney + ", loanItemLevel=" + loanItemLevel
				+ ", isNewItem=" + isNewItem + ", totalOverDueDays="
				+ totalOverDueDays + ", overDueInterests=" + overDueInterests
				+ ", overDueCapital=" + overDueCapital + ", termRepay=" + termRepay
	...
	public Date getIteBidDate() {
		return iteBidDate;
	}
	public void setIteBidDate(Date iteBidDate) {
