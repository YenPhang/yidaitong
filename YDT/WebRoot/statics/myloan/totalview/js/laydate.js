	...
	C.prototype = [],
		...
		T.prototype.render = function() {
			...
			if(t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2),
				...
				var m = w.elem("style"),
					u = ["#{{id}} .layui-laydate-header{background-color:{{theme}};}"].join("").replace(/{{id}}/g, e.elemID).replace(/{{theme}}/g, t.theme);
		...
		T.prototype.calendar = function(e) {
			...
			if(l.year < d[0] && (l.year = d[0], r.hint("最低只能支持到公元" + d[0] + "年")), l.year > d[1] && (l.year = d[1], r.hint("最高只能支持到公元" + d[1] + "年")), r.firstDate || (r.firstDate = w.extend({},
					l)), c.setFullYear(l.year, l.month, 1), t = c.getDay(), a = n.getEndDate(l.month, l.year), i = n.getEndDate(l.month + 1, l.year), w.each(y,
					function(e, n) {
					...
					e && (r.listYM = [
						...
						r.systemDate(), r.endTime)) : r.setBtnStatus(!0))), s.range || (r.listYM = [
					[l.year, l.month + 1]
		...
		T.prototype.change = function(e) {
			...
			return {
				...
				prevMonth: function() {
					...
					var nowYearMonth = $(".laydate-set-ym span").attr("lay-ym");
