				...
				<div class="con_l">
					...
					<div class="bd nav_l">
						<ul class="ul_v">
							...
							<li class="li6" >
								<a class="t" href="${pageContext.request.contextPath}/manager/tonoticelist.html"><span></span>公告管理</a>
								<script type="text/javascript" >
								...
								<div class="zmenu"><a href="https://app.etongdai.com/message/mymessage?type=0"><i>▪</i>修改公告
										<p class="yuan">0</p>
									</a>
								</div>
								<div class="zmenu">
