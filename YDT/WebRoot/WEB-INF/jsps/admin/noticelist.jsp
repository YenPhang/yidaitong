...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link type="/image/x-icon" rel="Icon" href="${pageContext.request.contextPath}/statics/admin//etd.ico" />
		<link type="/image/x-icon" rel="Shortcut Icon" href="${pageContext.request.contextPath}/statics/admin//etd.ico" />
		<link type="/image/x-icon" rel="Bookmark" href="${pageContext.request.contextPath}/statics/admin//etd.ico" />
...
<![endif]-->
		<link href="${pageContext.request.contextPath}/statics/admin/css/com.css" rel="stylesheet">
		<link href="${pageContext.request.contextPath}/statics/admin/css/tf.css" rel="stylesheet">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/statics/admin/css/normalize.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/statics/admin/css/iconfont.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/statics/admin/css/base.css">
		...
		<script src="${pageContext.request.contextPath}/statics/admin/js/jquery-1.7.2.min.js" type="text/javascript" charset="utf-8"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/statics/admin/js/digital.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/statics/admin/js/base.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/statics/admin/js/localjs/noticelist.js"></script>
		<script src="${pageContext.request.contextPath}/statics/admin/js/eframe.js" type="text/javascript" charset="utf-8"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/statics/admin/js/fancyselect.js" charset="utf-8"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/statics/admin/js/md5.js"></script>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/statics/admin/css/my_com.css" />
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/statics/admin/css/ts.css" />
		<style>
	...
	<body>
		...
		<section class="copyright">
			<div class="authentic">
				...
				<a id="ppb" key="587c78dbefbfb04f3bf057c6" logo_size="124x47" logo_type="business" href="http://www.anquan.org">
					<script src="${pageContext.request.contextPath}/statics/admin/js/aq_auth.js"></script>
				</a>
			</div>
		...
		<script src="${pageContext.request.contextPath}/statics/admin/js/jquery.cookie.js" type="text/javascript" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath}/statics/admin/js/html5.js" type="text/javascript" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath}/statics/admin/js/common.js"></script>
		<script>
			var _this = $("#ppb");
		...
		<div style="display:none;">
			<script src='${pageContext.request.contextPath}/statics/admin/js/tongji_360.js' language='JavaScript' charset='gb2312'></script>
		</div>
